...
export const updateWeather = function (lat, lon) {
   ...
   */
    ...
    const hourlytSection = document.querySelector("[data-hourly-forecast]");
    const forecastSection = document.querySelector("[data-5-day-forecast]");

    currentWeatherSection.innerHTML = "";
    highlightSection.innerHTML = "";
    hourlytSection.innerHTML = "";
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        const {
            weather,
            dt: dateUnix,
            sys: {sunrsie: sunriseUnixUTC, sunset: sunsetUnixUTC},
            main: {
        ...
        fetchData(url.forecast(lat, lon), function (forecast){
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                `;
                hourlytSection.querySelector("[data-temp]").appendChild(tempLi);
                ...
                `;
                hourlytSection.querySelector("[data-wind]").appendChild(windLi);
            }
            forecastSection.innerHTML = `
